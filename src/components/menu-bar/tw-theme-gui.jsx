...
import {GUI_MAGIC_DARK, GUI_MAGIC_LIGHT, GUI_DARK, GUI_LIGHT, GUI_MIDNIGHT, Theme} from '../../lib/themes/index.js';
...
const options = defineMessages({
    [GUI_MAGIC_LIGHT]: {
        defaultMessage: 'MagicMod - Light',
        description: 'Name of MagicMod\'s Light color scheme.',
        id: 'tw.gui.light'
    },
    [GUI_LIGHT]: {
    ...
    [GUI_MAGIC_DARK]: {
        defaultMessage: 'MagicMod - Dark',
        description: 'Name of MagicMod\'s Dark color scheme.',
        id: 'tw.gui.dark'
    },
    [GUI_DARK]: {
        defaultMessage: 'Dark',
...
const icons = {
	...
	[GUI_MAGIC_LIGHT]: lightModeIcon,
    [GUI_DARK]: darkModeIcon,
    [GUI_MAGIC_DARK]: darkModeIcon,
